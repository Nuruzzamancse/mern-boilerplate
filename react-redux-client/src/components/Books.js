...
export default class Books extends React.Component {
  ...
  cofirmDeleteTodo(){
    this.props.mappedDeleteTodo(this.props.mappedBookState.bookToDelete);
  }

  render(){
    const todoState = this.props.mappedBookState;
    const todos = todoState.books;
    const editTodo = todoState.bookToEdit;
    return(
      ...
      <tbody>
        ...
        <td>{todo.bookText}</td>
         ...
         <td className="textCenter"><Link to={`/books/${todo._id}`}>View Details</Link> </td>
         </tr> )
      }
      </tbody>
      </table>
    ...
    <div className="col-md-12">
    {editTodo  &&
    <BookEditForm todoData={editTodo} editTodo={this.submitEditTodo} />
    }
